{
  ...
  document.write("creaArray('secuoya', 'pino', 'roble', Array('pino mediterraneo', 'pino atlántico')) <br>");
  document.write(creaArray("secuoya", "pino", "roble", Array("pino mediterraneo", "pino atlántico") ));
}